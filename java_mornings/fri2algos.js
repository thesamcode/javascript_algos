...
class DoublyLinkedList {
  ...
  insertAfter(targetVal, newVal) {    
    ...
    while (runner){
      if (this.tail == targetVal && runner == this.tail){
...
console.log(singleNodeList.insertAfter(2,2))
console.log(singleNodeList.toArray())
console.log(biNodeList.insertAfter(2,2))
console.log(biNodeList.toArray())
console.log(firstThreeList.insertAfter(2,2))
console.log(firstThreeList.toArray())
console.log(secondThreeList.insertAfter(2,2))
console.log(secondThreeList.toArray())
console.log(unorderedList.insertAfter(2,2))
console.log(unorderedList.toArray())

// console.log(singleNodeList.insertBefore(1,2))
// console.log(singleNodeList.toArray())
// console.log(biNodeList.insertBefore(1,2))
// console.log(biNodeList.toArray())
// console.log(firstThreeList.insertBefore(1,2))
// console.log(firstThreeList.toArray())
// console.log(secondThreeList.insertBefore(1,2))
// console.log(secondThreeList.toArray())
// console.log(unorderedList.insertBefore(1,2))
// console.log(unorderedList.toArray())
