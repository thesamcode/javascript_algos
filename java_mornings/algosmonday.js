...
fourLevelTree.root = new BSTNode(25);
fourLevelTree.root.left = new BSTNode(15);
fourLevelTree.root.left.left = new BSTNode(10);
fourLevelTree.root.left.left.left = new BSTNode(4);
fourLevelTree.root.left.right = new BSTNode(6);
fourLevelTree.root.right = new BSTNode(15);
fourLevelTree.root.right.left = new BSTNode(13);