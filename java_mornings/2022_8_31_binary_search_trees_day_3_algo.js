...
class BinarySearchTree {
  ...
  insertRecursive(newVal, curr = this.root) {
    ...
    if (curr.data != newVal){
      return this.insertRecursive(curr)
    }
...
// console.log(emptyTree.insert(12));

// console.log(oneNodeTree.insert(12));
...
console.log(twoLevelTree.insert(12));
// console.log(twoLevelTree.toArr());
