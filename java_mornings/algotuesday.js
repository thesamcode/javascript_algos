...
class BinarySearchTree {
  ...
  range(startNode = this.root) {
    // (startNode.left == null && startNode.right == null)) return null;
...
// console.log(oneNodeTree.contains(15));
...
// console.log(twoLevelTree.contains(100));
...
console.log(threeLevelTree.contains(44));
...
// (44) if val greater than root, .right
// if value is less than root, .left
