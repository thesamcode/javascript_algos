...
//   size() {
//     console.log(this.toArrInorder().length);
// }
  ...
  isFull(node = this.root) {
    ...
    //if both are not null, then the current node is full
    if (node.left != null && node.right != null) return (this.isFull(node.left) && this.isFull(node.right))
